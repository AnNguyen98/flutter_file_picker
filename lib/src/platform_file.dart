...
class PlatformFile {
  ...
  /// Read more about it [here](https://github.com/AnNguyen98/flutter_file_picker_af/wiki/FAQ)
  String? _path;

  String? get path {
    if (kIsWeb) {
      /// https://github.com/AnNguyen98/flutter_file_picker_af/issues/751
      throw '''
  ...
  /// [Check here in the FAQ](https://github.com/AnNguyen98/flutter_file_picker_af/wiki/FAQ) an example on how to use it to upload on web.
